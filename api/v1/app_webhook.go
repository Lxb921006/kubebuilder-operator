...
func (r *App) Default() {
	...
	if !r.Spec.EnableService {
		r.Spec.EnableService = true
	}
...
func (r *App) validateApp() error {
	...
	if !r.Spec.EnableService {
		allErrs = append(allErrs, field.Invalid(field.NewPath("spec").Child("enable_service"), r.Name, "enable_service must be true"))
	}
